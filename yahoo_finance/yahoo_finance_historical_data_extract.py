...
##        self.hist_database_path = r'C:\data\stock_sql_db\stock_hist.db'
        ...
        self.hist_quotes_csvfile_path = r'./data/raw_stock_data' # for storing of all stock raw data
        self.tempfile_sav_location = r'./data/temp/temp_hist_div_data_save.csv'
